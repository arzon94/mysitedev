...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/arzon94" style={ { color: colorPrimary } }><i className="fab fa-github"></i></a>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://stackexchange.com/users/10928847/andrew" style={ { color: colorPrimary } }><i className="fab fa-stack-overflow"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://linkedin.com/in/andrew-perkins" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://angel.co/andrew-perkins-5" style={ { color: colorPrimary } }><i className="fab fa-angellist"></i></a>
